...
export const ADMIN_ENTITIES: Record<AdminEntityKey, AdminEntityConfig> = {
  ...
  parking: {
    ...
    fields: [
      ...
      { name: "slug", label: "Slug", type: "text", required: true },
      {
        ...
        type: "select",
        required: true,
        options: ["bus", "two_wheeler", "four_wheeler", "accessible"],
      },
      { name: "capacity", label: "Capacity", type: "number" },
      {
        name: "current_occupancy",
        label: "Current occupancy (operator-entered)",
        type: "number",
      },
      { name: "entry_info", label: "Entry info", type: "textarea" },
      { name: "exit_info", label: "Exit info", type: "textarea" },
      { name: "shuttle_note", label: "Shuttle connectivity", type: "textarea" },
      { name: "latitude", label: "Latitude", type: "number" },
      { name: "longitude", label: "Longitude", type: "number" },
    ],
  },
  accommodation: {
    ...
    fields: [
      ...
      { name: "slug", label: "Slug", type: "text", required: true },
      {
        ...
        type: "select",
        required: true,
        options: ["hotel", "dharamshala", "ashram", "tent_camp", "government"],
      },
      {
        name: "price_tier",
        label: "Price tier",
  ...
  essential_services: {
    ...
    titleField: "name",
    labelKey: "entityEssentialServices",
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      { name: "slug", label: "Slug", type: "text", required: true },
      {
